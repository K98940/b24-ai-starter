...
3. После внесения CLIENT_ID и CLIENT_SECRET в файл `.env`, перезапустите контейнеры разработки и установите приложение в вашем портале Битрикс24.

4. Для использования в production-среде настоятельно рекомендуется внести свои значения в переменные окружения:
...
- **🎨 [Frontend Knowledge](./instructions/frontend/knowledge.md)** - общие знания по frontend-разработке
  - [UI Kit](./instructions/frontend/bitrix24-ui-kit.md) - работа с UI Kit
  - [JS SDK](./instructions/frontend/bitrix24-js-sdk.md) - работа с JS SDK
  - [Компоненты](./instructions/frontend/) - детальные инструкции по компонентам
